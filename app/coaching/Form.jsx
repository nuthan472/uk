...
const Form = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-gray-700 to-white p-6 py-4  shadow-2xl max-w-md mx-auto w-full h-[37rem] sm:h-[37rem] md:h-[37rem] lg:h-[36rem] tablet:h-[37rem] shadow-gray-500 mb-6 lg:mb-2" style={{fontFamily: "Times New Roman, serif"}}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-3 mt-2 lg:mt-2">
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className=" bg-gray-800 text-white py-2 rounded-lg font-semibold hover:bg-orange-600 transition-all duration-200 shadow-lg -mt-4 md:-mt-0 md:w-3/4"
            disabled={loading}
          >
